...
public class BaseTestSauceLab {
	...
	public void setUp(String browserName, String versionName, String platformName ,  Method name) {
		...
		sauceOpts.setCapability("username", "oauth-amitkr1683-87114");		//get it from sauce lab user setting
		sauceOpts.setCapability("accessKey", "3c23757d-2ab6-4806-a73c-1cabbab7041d");		//get it from sauce lab user setting
